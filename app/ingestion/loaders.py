...
# MinerU рендерит страницы в несколько процессов и на больших PDF съедает
# всю память. Держим один рендер-процесс: медленнее, но не ловим OOM.
